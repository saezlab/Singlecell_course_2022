...
*Can we claim that the some of the hallmark states or processes show spatial patterns? Why not?*
...
-   Are genes with significant spatial patterns colocalized? Visualize or try to quantify.

-   Try running the same analysis on a cancer sample.
